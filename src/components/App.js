    ...
    return (
      <div>
        ...
        <footer id="mainfoot" className="mainfoot page-footer bg-light rounded footer-adj" style={{display: "block"}}>
          <br />
          <p className="text-center"><img src="/logo.png" border="0" height="100px" /><br /><br />Syfin ERC721 NFT Market on the Fantom Blockchain<br /><span style={{fontSize: "13px"}}>Alpha Version v1.4.3</span></p>
