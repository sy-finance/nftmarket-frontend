...
class NotFoundPage extends React.Component{
    render(){
        return <div align="center" style={{minHeight: "1000px", backgroundColor: "#000", borderRadius: "15px", padding: "40px"}}>
            <h1 className="text-light">Page not found</h1><br />    
            <p style={{textAlign:"center", color: "#FFF"}}>
            <i className="fas fa-exclamation-triangle" style={{fontSize: "158px"}}></i>
