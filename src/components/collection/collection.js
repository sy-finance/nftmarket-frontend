                ...
                <div className="container-fluid mb-5 my-collect-adj">
                    <div className="row justify-content-around">
                                                        ...
                                                        </>
                        {
                                                    ...
                                                    (<div style={{position: "relative", width: "100px"}}><Img src={"https://ipfs.sy.finance/ipfs/"+this.state.ipfs} cache alt="" border="0" height="100px" width="100px"  style={{borderRadius: "50%"}} />
