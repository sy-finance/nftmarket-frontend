        ...
        return (
            <div>
                ...
                <div className="container-fluid mb-5 explore-adj">
                    ...
                    <p align="center" className="text-secondary">This is where you can view recently gifted SYF NFTs! This displays the last 15 gifted SYF NFTs!</p>
                                        ...
                                        <Link to={{
                                            ...
                                            <form onSubmit={(event) => {
                                                ...
                                                <div className="m-2" align="center">{
                                                    ...
                                                    ( <div style={{position: "relative", marginTop: "10px", marginBottom: "0px", width: "45px"}}><Jazzicon diameter={45} seed={jsNumberForAddress(this.state.imageData_receiver[key])} />
