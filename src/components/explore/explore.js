        ...
        return (
            <div>
                ...
                <div className="container-fluid mb-5 explore-adj">
                    ...
                    <div align="center"><a href="/oldest" className="btn btn-primary">Oldest NFTs First</a><br /><br /></div>
                            ...
                            return (
                                ...
                                (this.state.approved[key] && this.state.ready === true) ?
                                    ...
                                    <div key={key} className="col-md-2 card bg-light m-3 p-2">
                                        <ReactPlaceholder type='rect' ready={this.state.approved[key]} showLoadingAnimation={true} color='#333' style={{ width: '300px', height: '300px', borderRadius: '15px' }}>                                    
                                        <Link to={{
