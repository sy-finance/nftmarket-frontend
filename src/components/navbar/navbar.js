              ...
              {(window.loaded_web3 && this.state.account.length > 0) ?
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                {
                  ...
                  (
                    ...
                    <NavDropdown title={
                        (this.state.ipfs !== "" && (this.state.mim === "image/jpeg" || this.state.mim === "image/png" || this.state.mim === "image/gif")) ?
                        ( <div style={{position: "relative", width: "38px", margin: "0 auto"}}><Img src={"https://ipfs.sy.finance/ipfs/"+this.state.ipfs} cache alt="" border="0" height="38px" width="38px" style={{borderRadius: "50%"}} />
                      ...
                      <NavDropdown.Item href="/draw">Drawing (Beta)</NavDropdown.Item>
                      {(this.state.verified !== true) ? (
                      ...
                      <NavDropdown.Item href={"https://github.com/sy-finance/nftmarket-frontend"} target="_blank">Github 🡕</NavDropdown.Item>
                    </NavDropdown>
                    </Nav>
                        </>
                  ) : ( 
